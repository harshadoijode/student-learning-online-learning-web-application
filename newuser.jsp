...
<div align="center">
  ...
  <br />
  <br />
  <span class="style11">New Students Registration Form</span></div>
...
try{
int x=stmt.executeUpdate("insert into studentreg  value('"+request.getParameter("s1")+"','"+request.getParameter("s2")+"','"+request.getParameter("s3")+"','"+request.getParameter("s4")+"')");
if(x!=0){
out.print("student Registered successfully");
}
}catch(Exception e){
